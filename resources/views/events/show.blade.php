...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen">
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium transition">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="bg-gray-900 dark:bg-gray-700 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-800 dark:hover:bg-gray-600 transition">
                                Register
                            </a>
                        @endif
                    @endauth
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <a href="{{ url('/') }}"
            class="inline-flex items-center text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-300 mb-6 transition">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            <!-- Hero Image -->
            <div
                class="h-96 bg-gradient-to-br from-purple-400 to-indigo-600 dark:from-purple-600 dark:to-indigo-800 relative">
                ...
                <div class="absolute top-6 right-6">
                    ...
                    @if($status === 'open')
                        <span
                            class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
                            <span class="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></span>
                            Open
                        </span>
                    @else
                        <span
                            class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200">
            ...
            <div class="p-8">
                ...
                <div class="flex flex-wrap items-center gap-6 mb-8 text-gray-600 dark:text-gray-400">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <strong>Mulai:</strong> {{ $event->start_date->format('F d, Y \a\t g:i A') }} <br>
                            <strong>Selesai:</strong> {{ $event->end_date->format('F d, Y \a\t g:i A') }}
                        </div>
                    </div>
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="h-12 w-12 rounded-full bg-gradient-to-br from-purple-400 to-indigo-600 flex items-center justify-center">
                    ...
                    <div class="lg:col-span-1">
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 sticky top-8">
                                        ...
                                        <div class="space-y-3">
                                            @foreach($event->tickets as $index => $ticket)
                                                <label
                                                    ...
                                                    <div class="flex items-center">
                                                        <input type="radio" name="ticket_id" value="{{ $ticket->ticket_id }}" {{ $index === 0 ? 'checked' : '' }}
                                    ...
                                    @auth
                                        @if(auth()->user()->role === 'attendee')
                                            ...
                                            <button type="button" id="checkoutBtn"
                                                class="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 shadow-lg hover:shadow-xl">
                                                Checkout
                                            </button>
                                        @else
                                            ...
                                            <div
                                                ...
                                                <p class="text-sm text-orange-800 dark:text-orange-300 mb-3">
                                                    You're logged in as {{ auth()->user()->role }}. Please logout to continue as
                                                    attendee
                                                </p>
                                                <div class="space-y-2">
                                                    <form method="POST" action="{{ route('logout') }}" class="w-full">
                                                        ...
                                                        <input type="hidden" name="redirect"
                                                            value="{{ route('login') }}?redirect={{ urlencode(url()->current()) }}">
    ...
    <!-- VA Success Modal -->
    <div id="vaModal"
        class="fixed flex items-center justify-center inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div
            class="relative bg-white dark:bg-gray-800 w-11/12 md:w-2/3 lg:w-1/2 max-h-[90vh] rounded-lg shadow-lg overflow-y-auto p-5">
            <!-- Modal Content -->
            <div class="mt-3">
                ...
                <!-- VA Number Display -->
                <div
                    class="bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-lg p-6 mb-4 border border-purple-200 dark:border-purple-800">
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Virtual Account Number</p>
                    <div class="flex items-center justify-between">
                        <span id="vaNumber"
                            class="text-2xl font-bold text-gray-900 dark:text-white font-mono tracking-wider"></span>
                        <button id="copyVaBtn"
                    ...
                    <div
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-yellow-700 dark:text-yellow-400 mt-1">Please complete your
                                    payment before the expiration time. Your booking will be cancelled if payment is not
                                    received.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex space-x-3 mt-6">
                    ...
                    <button id="vaContinueBtn"
                        class="flex-1 px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-lg transition shadow-lg hover:shadow-xl">
                        Make Payment
                    </button>
                </div>
            </div>
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-3">
                        ...
                        <p class="text-gray-700 dark:text-gray-300">
                            <strong>Mulai:</strong> {{ $event->start_date?->format('F d, Y \a\t g:i A') }}
                        </p>
                        <p class="text-gray-700 dark:text-gray-300">
                            <strong>Selesai:</strong> {{ $event->end_date?->format('F d, Y \a\t g:i A') }}
                        </p>
                    ...
                    <div class="flex justify-between items-center pt-2">
                        ...
                        <span id="modalTotal" class="text-2xl font-bold text-purple-600 dark:text-purple-400">Rp
                            0</span>
                    </div>
                </div>
