                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <p class="text-gray-900">{{ $event->event_date?->format('d F Y, H:i') ?? '—' }}</p>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <p class="text-gray-900">{{ number_format($event->event_capacity) }} orang 
                                <span class="text-sm text-gray-600">(Terisi: {{ $event->ticket_holders->count() }})</span>
                            </p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            <p class="text-gray-700 whitespace-pre-wrap">{{ $event->event_description ?? 'Tidak ada deskripsi.' }}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            @foreach($event->tickets as $ticket)
                                <div class="border-2 border-indigo-100 rounded-lg p-4 bg-gradient-to-br from-indigo-50 to-purple-50">
